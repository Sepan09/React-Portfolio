...
export default function Home() {
        ...
        <Box sx={{
            ...
            <Typography variant="h1" sx={{maxWidth: "500px", fontSize: "70px", fontWeight: 600}}>
                ...
                <Link to="https://www.linkedin.com/in/sepan-mustafa-73b0412a4/" style={{textDecoration: "none", color: "black", fontSize: "38px",  padding: "0 20px 0 0"}} >
                    <FaLinkedin />
                </Link>
                <Link to="https://github.com/Sepan09" style={{textDecoration: "none", color: "black", fontSize: "38px"}} >
                    <FaGithub />
                </Link>
            </Typography>
